...
class Settings(BaseSettings):
    ...
    gallery_public_enabled: bool = Field(default=True, validation_alias="GALLERY_PUBLIC_ENABLED")
    gallery_public_per_hour: int = Field(default=5, ge=1, le=1000, validation_alias="GALLERY_PUBLIC_PER_HOUR")
    gallery_public_per_day: int = Field(default=3, ge=1, le=10_000, validation_alias="GALLERY_PUBLIC_PER_DAY")
